...
$data = new Databases; 
$listerv =$data->add('rendezvous',"patient","medcin","secretaire","planning","specialite");
...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
      <li class="active"><a href="admin.php">medcin</a></li>
  ...
  <div class="rowmed">
    ...
    <br>
    <br>
<center><h1> rendezvous</h1></center>
...
foreach($listerv as $value){
  ...
  <td><?php echo $value["nom_secretaire"];?></td>
